#
# thanks to: https://github.com/pjmattingly/ant-colony-optimization
#
# but this script has a defect:
# AttributeError: 'dict_keys' object has no attribute 'remove'
# at line: 36
# self.possible_locations = possible_locations
# that should be self.possible_locations = list(possible_locations)
